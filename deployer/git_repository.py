...
class DeployLogGitRepository:
    ...
    def write(self, path, data):
        ...
        DeployLogGitRepository.__write_service_file(path, data)
    ...
    def get_previous_recipe(self, service_name):
        path = os.path.join(self.env, 'services', service_name + '.yml')
